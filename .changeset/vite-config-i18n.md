...
- `layers()` returns both, for a tier to extend with. A list rather than a tier, because a library
  and an application both ship catalogues and each picks its own tier.
