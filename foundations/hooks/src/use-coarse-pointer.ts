/**
 * Answers whether the reader's main pointer is a finger rather than a mouse or a pen.
 */
 ...
 *   drag is left out.
 * @returns `true` for a finger, and `false` for a mouse or a pen and before the window has
 *   answered.
 */
