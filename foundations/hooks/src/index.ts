 ...
 * read, what it measures, and what it held a render ago. Each one reads React and the document and
 * names nothing else, so a package that draws no component still installs only React to use them.
 *
