...
- [#27](https://github.com/stealth-scale/config/pull/27) [`83f3481`](https://github.com/stealth-scale/config/commit/83f34814305877c1b60fa3a06ccfd1644c159615) Thanks [@stealth-rklopper](https://github.com/stealth-rklopper)! - provider-i18n: put the strings an application is read in into scope
