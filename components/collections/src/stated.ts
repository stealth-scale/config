 ...
 *   and the list of which settings default is the machine's own and different for each one. This
 *   drops every setting nobody set, which leaves the machine to apply its own defaults.
 */
