 ...
 * drawn nowhere, one tab stop over a set of controls, and a way past the navigation. Each component
 * binds a recipe a theme can extend and draws nothing of its own. The recipes reach an
