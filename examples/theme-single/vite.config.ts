/**
 * Builds this example as a React application in one theme: the React layers, the stylesheet
 * compiler and a port of its own.
 *
 * @remarks
 *   The compiler reads `theme.config.ts` for the one theme, and the preset of every package on the
