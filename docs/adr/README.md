...
| [0020](0020-route-with-tanstack-router.md)                                                  | Route with TanStack Router                                                          | Proposed |
| [0021](0021-publish-the-pieces-a-router-is-built-from.md)                                   | Publish the pieces a router is built from                                           | Proposed |
| [0022](0022-create-a-compiled-route-under-its-parent.md)                                    | Create a compiled route under its parent rather than grafting it into a built tree  | Proposed |
...
| [0028](0028-make-a-json-schema-document-the-source-of-a-form.md)                            | Make a JSON Schema document the source of a form                                    | Proposed |
| [0029](0029-evaluate-every-schema-through-one-engine-per-page.md)                           | Evaluate every schema through one engine per page                                   | Proposed |
| [0030](0030-put-the-schema-in-the-dynamic-slot-and-every-other-rule-in-the-librarys-own.md) | Put the schema in the dynamic slot and every other rule in the library's own        | Proposed |
| [0031](0031-state-a-forms-presentation-as-data-keyed-by-path.md)                            | State a form's presentation as data keyed by path                                   | Proposed |
| [0032](0032-derive-every-message-identifier-from-the-form-and-the-path.md)                  | Derive every message identifier from the form's identifier and the path             | Proposed |
