...
> = {
  ...
  cyan: {
    ...
    emphasized: ["tint60", "shade40"],
    fg: ["shade20", "tint30"],
    "fg.muted": ["shade20", "tint40"],
    focusRing: ["shade10", "tint20"],
    muted: ["tint60", "shade40"],
  ...
  green: {
    ...
    contrast: { value: { _dark: "{colors.gray.black}", base: "{colors.gray.white}" } },
    emphasized: ["tint60", "shade20"],
    fg: ["shade10", "tint40"],
    "fg.muted": ["primary", "tint50"],
    focusRing: ["primary", "tint20"],
    muted: ["tint60", "shade30"],
  ...
  orange: {
    ...
    "border.hover": ["shade10", "primary"],
    contrast: { value: { _dark: "{colors.gray.black}", base: "{colors.gray.black}" } },
    emphasized: ["tint40", "shade40"],
    fg: ["shade30", "tint30"],
    "fg.muted": ["shade30", "tint40"],
    focusRing: ["shade10", "tint20"],
    muted: ["tint40", "shade40"],
    solid: ["primary", "primary"],
    "solid.hover": ["shade10", "tint10"],
    subtle: ["tint60", "shade40"],
  },
  pink: {
    ...
    emphasized: ["tint50", "shade40"],
    fg: ["shade20", "tint30"],
    "fg.muted": ["shade20", "tint40"],
    focusRing: ["primary", "tint20"],
    muted: ["tint50", "shade40"],
    solid: ["shade10", "shade10"],
    "solid.hover": ["shade20", "shade10"],
    subtle: ["tint60", "shade40"],
  },
  purple: {
    bg: ["tint60", "shade50"],
    ...
    contrast: { value: { _dark: "{colors.gray.black}", base: "{colors.gray.white}" } },
    emphasized: ["tint40", "shade20"],
    fg: ["shade10", "tint40"],
    "fg.muted": ["primary", "tint40"],
  ...
  teal: {
    ...
    emphasized: ["tint60", "shade40"],
    fg: ["shade10", "tint30"],
    "fg.muted": ["shade10", "tint40"],
    focusRing: ["primary", "tint20"],
    muted: ["tint60", "shade40"],
    solid: ["primary", "primary"],
    "solid.hover": ["shade10", "primary"],
    subtle: ["tint60", "shade40"],
  },
  yellow: {
    bg: ["tint60", "shade50"],
