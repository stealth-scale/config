...
import { BODY, RATIO, tokens } from "#graphite/tokens.ts";

describe("tokens", () => {
  it("sets the body face to Mona Sans Variable", () => {
    expect(tokens.fonts?.["body"]?.value).toContain("Mona Sans Variable");
  });
